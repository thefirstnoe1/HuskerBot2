...
object SeasonResolver {
    ...
    private val nflWeeks: List<Instant> = listOf(
        ...
        LocalDateTime.parse("${nflSeason}-09-09T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason}-09-16T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason}-09-23T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason}-09-30T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason}-10-07T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason}-10-14T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason}-10-21T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason}-10-28T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason}-11-04T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason}-11-11T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason}-11-18T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason}-11-25T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason}-12-02T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason}-12-09T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason}-12-16T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason}-12-23T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason}-12-30T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason + 1}-01-06T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason + 1}-01-13T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason + 1}-01-20T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason + 1}-01-27T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
        LocalDateTime.parse("${nflSeason + 1}-02-03T00:00:00").atZone(ZoneId.of("America/Chicago")).toInstant(),
